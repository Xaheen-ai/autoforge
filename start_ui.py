...
def main() -> None:
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Xaheen UI Launcher")
    ...
    if host != "127.0.0.1":
        ...
        print("  The Xaheen UI will be accessible from other machines.")

...
def test_yaml_loading():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Test 1: Valid YAML
        config_path = xaheen_dir / "allowed_commands.yaml"
...
""")
        ...
        (project_dir / ".xaheen" / "allowed_commands.yaml").unlink()
        config = load_project_commands(project_dir)
        if config is None:
...
""")
                ...
                project_xaheen = project_dir / ".xaheen"
                project_xaheen.mkdir()
                project_config = project_xaheen / "allowed_commands.yaml"

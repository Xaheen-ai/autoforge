...
**Output location:** `$ARGUMENTS/.xaheen/prompts/app_spec.txt` and `$ARGUMENTS/.xaheen/prompts/initializer_prompt.md`
...
The output directory is: `$ARGUMENTS/.xaheen/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `$ARGUMENTS/.xaheen/prompts/app_spec.txt`
...
**Output path:** `$ARGUMENTS/.xaheen/prompts/initializer_prompt.md`
...
**Output path:** `$ARGUMENTS/.xaheen/prompts/.spec_status.json`
...
```json
{
  ...
  "files_written": [
    ".xaheen/prompts/app_spec.txt",
    ".xaheen/prompts/initializer_prompt.md"
  ],
...
```json
{
  ...
  "files_written": [
    ".xaheen/prompts/app_spec.txt",
    ".xaheen/prompts/initializer_prompt.md",
    ".xaheen/prompts/coding_prompt.md"
  ],
  "feature_count": 35
}
```
...
> "Your specification files have been created in `$ARGUMENTS/.xaheen/prompts/`!
>
> **Files created:**
> - `$ARGUMENTS/.xaheen/prompts/app_spec.txt`
> - `$ARGUMENTS/.xaheen/prompts/initializer_prompt.md`
>
